...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ANIMATION DU SPLASH SCREEN EN PURE CSS (IMPOSSIBLE À BLOQUER) */
        ...
        /* CONTAINER PRINCIPAL (VISIBLE PAR DÉFAUT) */
        .main-container {
            max-width: 1100px;
            width: 90%;
...
<script>
    // Animation secondaire des points du splash
    ...
    // Bouton de collage ultra-sécurisé
